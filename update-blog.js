...
const newReinos = [
  ...
  },
  {
    ...
    lore: [
      {
        icon: "◈",
        texto: "Em Nevalis o mundo é congelado, pois o ar revolto traz consigo a neve. Há lugares melhores do que outros, mas, em geral, todas as cidades estão contornadas por uma nevasca. Os prédios e as casas são ligados por túneis e corredores que carregam seus moradores e os protegem. Mas, mesmo no lugar inóspito, os Nevaleanos puderam transformar a paisagem gelada e branca num local cheio de outdoors coloridos de néon e interativos."
      },
      {
        icon: "◈",
  ...
  },
  {
    ...
    lore: [
      {
        icon: "◈",
        texto: "Os Luxanaros são conhecidos como Falcor. São seres não orgânicos que vivem como se fossem, pois, após a bênção de Celestria, que lhes concedeu a cor, finalmente se tornaram capazes de sentir."
      },
      {
        icon: "◈",
  ...
  },
  {
    ...
    lore: [
      ...
      {
        icon: "◈",
        texto: "Com apenas dois meses de sol por ano, o reino vive submerso em uma noite quase eterna. Árvores retorcidas oferecem frutos tão perigosos quanto sedutores. As cidades, escondidas dentro de muralhas destruídas há eras, sobrevivem em dificuldade alucinante, embora dentro da “infelicidade” haja a risada genuína de um povo sóbrio, mas feliz. Casas de madeira rangem sob o vento constante, e ruas estreitas são cortadas por uma água escura e oleosa."
      },
      {
        icon: "◈",
  ...
  },
  {
    ...
    lore: [
      {
        icon: "◈",
        texto: "Embora não explorada por Tainá, Nuvens Exaltadas despertou o interesse da Pigmentadora do Vazio. Trata-se de um reino formado por ilhas suspensas, cobertas por natureza exuberante, interligadas por pontes e cachoeiras com correntes calmas o suficiente para que os seres pudessem usá-las como transporte."
      },
      {
        icon: "◈",
